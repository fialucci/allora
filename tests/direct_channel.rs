...
#[tokio::test]
async fn direct_channel_dispatch_order_and_success() {
...
#[tokio::test]
async fn direct_channel_error_short_circuits() {
...
#[tokio::test]
async fn direct_channel_async_dispatch() {
    let dc = DirectChannel::with_random_id();
    ...
    dc.send(Exchange::new(Message::from_text("async")))
        .await
        .unwrap();
